...
class _wishlistScreenState extends State<wishlistScreen> {
  ...
  Future<WishListModel> fetchwishList() async {
    ...
    final apiUrl =
        'http://kaverykannadadevangakulamatrimony.com/appadmin/api/wishlist?member_id=$member_id';
  ...
  Future<void> RemoveWishlist({
    ...
    const apiUrl =
        'https://kaverykannadadevangakulamatrimony.com/appadmin/api/remove_wishlist';
