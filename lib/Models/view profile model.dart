...
class ViewProfile {
  ...
  ViewProfile({
    ...
    required this.mothergotra_tname,
    required this.mothergotra_ename,
    required this.motherkula_tname,
    required this.motherkula_ename,
    required this.citizenship_name,
    required this.dateofbirth,
    required this.dosamdetails
  });

  factory ViewProfile.fromJson(Map<String, dynamic> json) {
    log("profile data : $json");
    return ViewProfile(
      preffered_kulla: json['preffered_kulla']??'',
      ...
      occupation_details:json['occupation_details'] ?? '', education_details: json['education_details'] ?? '',
      ...
      mothergotra_tname: json['mothergotra_tname'] ?? '',
      mothergotra_ename: json['mothergotra_ename'] ?? '',
      motherkula_tname: json['motherkula_tname'] ?? '',
      motherkula_ename: json['motherkula_ename'] ?? '',
        citizenship_name: json['citizenship_name'] ?? '',
